...
public class EarthquakeActivity extends AppCompatActivity {
    ...
    private EarthquakeAdapter mAdapter;   // private指的是其他的類都不能引用mAdapter，但EarthquakeActivity內的所有方法都可以引用它。在這層意義上它就是EarthquakeActivity內的一個global variable
    ...
    private class EarthquakeAsyncTask extends AsyncTask<String, Void, List<Earthquake>> {
         ...
         *
         * Reference the adapter in the EarthquakeAsyncTask onPostExecute() method.
         */
        @Override
